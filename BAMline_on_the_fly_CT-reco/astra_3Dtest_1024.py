...
astra.set_gpu_index([0], memory=1024*1024*1024)

vol_geom = astra.create_vol_geom(1024, 1024, 128)

angles = np.linspace(0, np.pi, 1024,False)
proj_geom = astra.create_proj_geom('parallel3d', 1.0, 1.0, 1024, 1024, angles)

# Create a simple hollow cube phantom
cube = np.zeros((128,1024,1024))
cube[:,128:895,128:895] = 1
cube[:,256:767,256:767] = 0
